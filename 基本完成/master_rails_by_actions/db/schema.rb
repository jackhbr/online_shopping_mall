...
ActiveRecord::Schema.define(version: 20180307184142) do
  ...
  create_table "shopping_carts", force: true do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.integer  "flagclick",  default: 0
  end

  add_index "shopping_carts", ["user_id"], name: "index_shopping_carts_on_user_id", using: :btree
  add_index "shopping_carts", ["user_uuid"], name: "index_shopping_carts_on_user_uuid", using: :btree
  ...
  create_table "users", force: true do |t|
    ...
    t.string   "uuid"
    t.integer  "clickflag",                       default: 0
    t.integer  "plusflag",                        default: 0
  end
